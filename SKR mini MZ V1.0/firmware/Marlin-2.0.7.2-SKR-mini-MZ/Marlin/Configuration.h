...
#define STRING_CONFIG_H_AUTHOR "(Khoa Truong, SKR-mini-MZ-BLTouch)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SKR-mini-MZ-BLTouch"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 388.37 }
...
#if ENABLED(BLTOUCH)
  #define BLTOUCH_DELAY 200 // *option
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -41.55, -16.5, 2 }
...
#define PREHEAT_2_TEMP_BED    0 // Default 110
